...
يدعم **TurboTags** اللغة العربية بشكل كامل من خلال أعمدة JSON القابلة للترجمة:

- إنشاء وإدارة الوسوم بالعربية
- دعم الكتابة من اليمين لليسار (RTL)
- البحث والتصفية بالعربية
...
// البحث عن وسوم بالعربية
$suggestions = Tag::suggestions('تق', null, 'ar');
```
