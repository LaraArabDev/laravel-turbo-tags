...
Start with the [README](../README.md) — it covers installation, configuration, and common use cases.
...
**Do not** open a public issue for security vulnerabilities. Please see our [Security Policy](../SECURITY.md).
